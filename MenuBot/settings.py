...
CONSTANCE_CONFIG = {
    ...
    "DELIVERY_FEE": (25000, 'Стоимость доставки'),
    "MIN_CART_AMOUNT_FOR_FREE_DELIVERY": (250000, 'Минимальная сумма корзины для бесплатной доставки'),
    "SERVICE_FEE_PERCENTAGE": (10, '% за обслуживание (0-100)'),
